...
describe('SES Email Provider Adapter', function () {
    ...
    beforeEach(function () {
        ...
        sandbox.stub(Module, '_load').callsFake(function (request, _parent) {
    ...
    describe('Constructor', function () {
        ...
        it('should throw helpful error if AWS SDK not installed', function () {
            ...
            const requireStub = sandbox.stub(Module, '_load');
    ...
    describe('Personalization Detection (Round 5 Fix)', function () {
        let adapter;
        let emailData;
